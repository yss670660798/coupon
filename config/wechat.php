...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wx452dbf54a4d2312a'),         // AppID
    'secret'  => env('WECHAT_SECRET', 'ad1cc987c0d2a12fffb40d6c474d4497'),     // AppSecret
     ...
     */
     'payment' => [
         'merchant_id'        => env('WECHAT_PAYMENT_MERCHANT_ID', '1490609462'),
         'key'                => env('WECHAT_PAYMENT_KEY', 'Fy5MPSdtN0IhmZX6nA14V0ehq9DKcfiS'),
